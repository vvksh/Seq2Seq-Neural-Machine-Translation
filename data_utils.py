...
def prepare_custom_data(data_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, from_vocab_path,to_vocab_path,vocabulary_size,
                  tokenizer=None):
  """Preapre all necessary files that are required for the training.
  ...
  data_to_token_ids(from_train_path, from_train_ids_path, to_vocab_path, tokenizer)
  ...
  data_to_token_ids(from_dev_path, from_dev_ids_path,to_vocab_path, tokenizer)
